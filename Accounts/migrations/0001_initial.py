    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_information', models.TextField(blank=True, default='Other Information...', null=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('courses', models.ManyToManyField(to='Registrar.Course')),
                ('program_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Registrar.program')),
            ],
        ),
        migrations.CreateModel(
            name='Registrar',
